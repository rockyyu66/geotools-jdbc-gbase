...
public class GBaseDialect extends SQLDialect {
    ...
    public Geometry decodeGeometryValue(
        ...
        // }
        try {
            return new WKTReader(factory).read(rs.getString(name));
        } catch (ParseException e) {
